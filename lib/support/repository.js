...
let Repository = class Repository {
     ...
     */
    composeCollection(rawCollection, modelConstructor, meta) {
        ...
        return new collection_1.Collection((this.useAdapter ? (0, adapter_1.mapCollection)(rawCollection, this.map) : rawCollection)
    ...
    composeModel(rawModel, modelConstructor) {
        ...
        return modelConstructor.hydrate(this.useAdapter ? (0, adapter_1.mapModel)(rawModel, this.map) : rawModel);
    }
};
