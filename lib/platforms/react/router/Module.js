    ...
    return (react_1.default.createElement(props.layout, null,
        react_1.default.createElement(react_router_1.Switch, null,
            props.routes.map((r, i) => {
                ...
                return shouldRedirect ? (react_1.default.createElement(react_router_1.Redirect, { from: fullPath, to: r.redirect || props.prefix, key: `route-${props.prefix}-${i}` })) : (react_1.default.createElement(react_router_1.Route, { exact: true, path: fullPath, render: (componentProps) => (
                    // @ts-ignore
                    react_1.default.createElement(r.component, Object.assign({}, componentProps))), key: `route-${props.prefix}-${i}` }));
            }),
            props.errorPage ? (react_1.default.createElement(react_router_1.Route, { component: props.errorPage })) : null)));
};
