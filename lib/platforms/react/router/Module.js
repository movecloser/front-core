    ...
    return (React.createElement(props.layout, null,
        React.createElement(react_router_1.Switch, null,
            props.routes.map((r, i) => {
                ...
                let shouldRedirect = 'redirect' in r
                ...
                return shouldRedirect ? (React.createElement(react_router_1.Redirect, { from: fullPath, to: r.redirect || props.prefix, key: `route-${props.prefix}-${i}` })) : (React.createElement(react_router_1.Route, { exact: props.strict, path: fullPath, render: (componentProps) => (
                    // @ts-ignore
