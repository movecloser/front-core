...
var Bootstrapper = /** @class */ (function () {
    function Bootstrapper(config) {
        ...
        this.routerBootstrapper = factories_1.routerFactory(config.byFile('router'), this.container);
        this.storeBootstrapper = factories_1.storeFactory(config.byFile('state'), this.container);
    }
    /**
