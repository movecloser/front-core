...
class Bootstrapper {
    constructor(config) {
        ...
        this.routerBootstrapper = (0, factories_1.routerFactory)(this.config.byFile('router'), this.container);
        this.storeBootstrapper = (0, factories_1.storeFactory)(this.config.byFile('store'), this.container);
    }
    /**
