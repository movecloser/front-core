...
var EventbusMiddleware = /** @class */ (function () {
    function EventbusMiddleware(eventbus) {
     ...
     */
    EventbusMiddleware.prototype.afterCall = function (response) {
     ...
     */
    EventbusMiddleware.prototype.beforeCall = function (resource, headers, body) {
        return { headers: headers, body: body };
    };
    EventbusMiddleware = __decorate([
        container_1.Injectable()
    ], EventbusMiddleware);
    return EventbusMiddleware;
}());
