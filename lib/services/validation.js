...
var Validation = /** @class */ (function () {
     ...
     * @return void
     */
    Validation.prototype.clearForm = function (form) {
        this._stream$.next({
            form: form,
            type: validation_1.ValidationEventType.Clear
        });
     ...
     * @return {Subscription}
     */
    Validation.prototype.onClear = function (form, callback) {
        ...
        return this._stream$.pipe(operators_1.filter(function (event) { return event.form === form || event.type === validation_1.ValidationEventType.Clear; })).subscribe(function () {
            callback();
        });
    };
    /**
     ...
     * @return {Subscription}
     */
    Validation.prototype.onErrors = function (form, field, callback) {
        if (!callback || typeof callback !== 'function') {
        ...
        return this._stream$.pipe(operators_1.filter(function (event) { return event.form === form ||
            event.type === validation_1.ValidationEventType.Error; }), operators_1.filter(function (event) {
            ...
            if (form === event.form) {
                ...
                if (event.hasOwnProperty('errors') &&
                    ...
                    errors.push.apply(errors, event.errors[field]);
                }
                callback(errors);
            }
        });
     ...
     * @return {Subscription}
     */
    Validation.prototype.onFormErrors = function (form, callback) {
        if (!callback || typeof callback !== 'function') {
        ...
        return this._stream$.pipe(operators_1.filter(function (event) {
            return event.form === form || event.type === validation_1.ValidationEventType.Error;
        })).subscribe(function (event) {
            var errors = [];
            /* istanbul ignore next */
            if (event.hasOwnProperty('errors')
                && typeof event.errors !== 'undefined') {
                errors.push.apply(errors, event.errors['message']);
            }
            callback(errors);
        });
    };
     ...
     * @return void
     */
    Validation.prototype.pushErrors = function (form, errors) {
        this._stream$.next({
            form: form,
