...
var InternalServerErrorMiddleware = /** @class */ (function () {
    function InternalServerErrorMiddleware() {
    }
    /**
     * Method to be called after call execution.
     * It handles side effects.
     */
    InternalServerErrorMiddleware.prototype.afterCall = function (response) {
     ...
     */
    InternalServerErrorMiddleware.prototype.beforeCall = function (resource, headers, body) {
        return { headers: headers, body: body };
    };
    InternalServerErrorMiddleware = __decorate([
        container_1.Injectable()
    ], InternalServerErrorMiddleware);
    return InternalServerErrorMiddleware;
}());
